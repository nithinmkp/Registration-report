...
$endif$
$if(mainfont)$
\usefonttheme{$ mainfont $} % use mainfont rather than sansfont for slide text
$endif$
$if(innertheme)$
...
$if(author)$
$if(short-author)$
\author[$short-author$]{$for(author)$$author$$sep$ \and $endfor$}
$else$
...
% -----------------------------------------------------------------------------------------------------
$if(titlegraphic)$
\titlegraphic{\includegraphics[scale=0.25]{$titlegraphic$}}
$endif$
